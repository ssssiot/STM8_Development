...
float SHT2x_CalcTemperatureC(unsigned short unsigned shortsT);
float SHT2x_CalcRH(unsigned short unsigned shortsRH);

float Get_SHT20_TEMP(void);
float Get_SHT20_HUM(void);*/


#define SHT2x_I2C_PORT          GPIOD
#define SHT2x_SDA_PIN           GPIO_PIN_1
#define SHT2x_SCL_PIN           GPIO_PIN_2

#define SHT2x_SCL_HIGH()        GPIO_WriteHigh(SHT2x_I2C_PORT, SHT2x_SCL_PIN)
#define SHT2x_SCL_LOW()         GPIO_WriteLow(SHT2x_I2C_PORT, SHT2x_SCL_PIN)

#define SHT2x_SDA_HIGH() 	GPIO_WriteHigh(SHT2x_I2C_PORT, SHT2x_SDA_PIN)
#define SHT2x_SDA_LOW()         GPIO_WriteLow(SHT2x_I2C_PORT, SHT2x_SDA_PIN)

#define SHT2x_SCL_STATE()       GPIO_ReadInputPin(SHT2x_I2C_PORT, SHT2x_SCL_PIN)
#define SHT2x_SDA_STATE()       GPIO_ReadInputPin(SHT2x_I2C_PORT, SHT2x_SDA_PIN)
